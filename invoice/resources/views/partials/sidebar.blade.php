                ...
                <ul class="nav">
                    <li class="nav-item nav-profile">
                        <a href="{{route('home')}}" class="nav-link">
                            <div class="nav-profile-image">
                                <img src="https://cdn.iconscout.com/icon/free/png-256/user-1648810-1401302.png" alt="profile">
                                <span class="login-status online"></span>
                                <!--change to offline or busy as needed-->
                            </div>
                            <div class="nav-profile-text d-flex flex-column">
                                <span class="font-weight-bold mb-2">Admin</span>
                                <span class="text-secondary text-small">Accessed</span>
                            </div>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="page-layouts">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="{{route('category')}}"><i class="fa fa-plus mr-2"></i> Add</a></li>

                                <li class="nav-item"> <a class="nav-link" href="{{route('show')}}"><i class="fa fa-plus mr-2"></i> All Category</a></li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#company" aria-expanded="false" aria-controls="company">
                            <i class="fa fa-briefcase mx-1"></i>
                        ...
                        <div class="collapse" id="company">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="{{route('service')}}">Add</a></li>
                                <li class="nav-item"> <a class="nav-link" href="{{route('service.show')}}">Show</a></li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="apps">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="{{route('company')}}">Add</a></li>
                                <li class="nav-item"> <a class="nav-link" href="{{route('company.show')}}">Show</a></li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="product">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="{{route('product')}}">Add</a></li>
                                <li class="nav-item"> <a class="nav-link" href="{{route('product.show')}}">Show</a></li>
