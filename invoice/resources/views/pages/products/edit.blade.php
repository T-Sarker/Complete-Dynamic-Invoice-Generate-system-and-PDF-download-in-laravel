...
@section('content')
    <div class="container">
      <div class="my-3">
        ...
        <form class="mt-5" method="POST" action="{{route('product.update')}}" >
          @csrf
          ...
          <div class="mb-3">
            <label for="company" class="form-label">Company</label>
             <input type="text" class="form-control" id="company" name="company" placeholder="Company name" value="{{$product->company}}">
              @error("company")
                <p class="alert alert-danger">{{$message}}</p>
              @enderror
          </div>
          ...
          <div class="mb-3">
            <label for="details" class="form-label">Details</label>
             <input type="text" class="form-control" id="details" name="details" placeholder="Details" value="{{$product->details}}">
              @error("details")
                <p class="alert alert-danger">{{$message}}</p>
              @enderror
          </div>
